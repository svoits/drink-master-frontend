...
`,nt=()=>{const i=R(),[t,n]=s.useState({photo:"",title:"",recipe:"",category:"",glasses:"",strength:"",ingredients:[{ingredient:"",measure:"",quantity:""},{ingredient:"",measure:"",quantity:""},{ingredient:"",measure:"",quantity:""}],textareaRecipe:""}),o=()=>{i(se(t)),console.log(t)};return e.jsxs(e.Fragment,{children:[e.jsx(Qe,{formData:t,setFormData:n}),e.jsx(He,{formData:t,setFormData:n}),e.jsx(et,{formData:t,setFormData:n}),e.jsx(tt,{type:"button",onClick:o,children:"Add"})]})},it=nt,at=g.h3`
  margin-bottom: 20px;
...
`,ot=()=>e.jsxs(rt,{children:[e.jsx(at,{children:"Follow Us"}),e.jsx(de,{})]}),lt=ot,st=g.ul`
  display: flex;
...
`,xt=()=>{const i=R(),t=$(a=>a.drinks.popularDrinks),{isLoading:n,error:o}=$(xe);return s.useEffect(()=>{i(ue())},[i]),e.jsxs("div",{children:[n&&e.jsx(ce,{}),o&&e.jsx("p",{children:"Sorry. There are no images ... 😭"}),e.jsx(st,{children:t.map(({_id:a,drinkThumb:r,drink:l,shortDescription:d})=>e.jsx(dt,{children:e.jsxs(ut,{href:`/api/drinks/popular/${a}`,children:[e.jsx(ct,{src:r,alt:l,width:90,height:90}),e.jsxs(pt,{children:[e.jsx(mt,{children:l}),e.jsx(ht,{children:d})]})]})},a))})]})},ft=xt;function yt(){return e.jsx("div",{children:e.jsxs(pe,{children:[e.jsx(fe,{title:"Add drink"}),e.jsx(it,{}),e.jsx(lt,{}),e.jsx(ft,{})]})})}export{yt as default};
