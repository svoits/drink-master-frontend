...
`,pn={backgroundColor:"#F3F3F3",width:"50px",height:"50px",borderRadius:"6px",color:"#161F37"},un=K().shape({drinkThumb:C().required("Cocktail photo is a mandatory field").url(),drink:C().required("Cocktail title is a mandatory field").min(3,"Cocktail name must contain at least 3 symbols"),description:C().required("Description of the cocktail is a mandatory field").min(10,"The cocktail description must contain at least 10 symbols"),category:C().required("Cocktail category is a required field"),glass:C().required("Cocktail glass is a required field")}),xn=Ke(),hn=({formData:e,setFormData:t,refId:i})=>{const a=V(),r=T(w=>w.filters.categories),o=T(w=>w.filters.glasses),[d,c]=s.useState(null),[p,x]=s.useState(!1),[h,v]=s.useState(null),[m,$]=s.useState("");s.useEffect(()=>{a(ce()),a(pe())},[a]);const b=w=>{const u=w.target.files[0];if(u){const g=URL.createObjectURL(u);t({...e,drinkThumb:u}),c(g),x(!0)}},y=w=>{const{name:u,value:g}=w.target;t({...e,[u]:g})};return n.jsx(nn,{children:n.jsx(R,{initialValues:e,validationSchema:un,innerRef:i,children:n.jsxs(tn,{children:[n.jsxs(rn,{htmlFor:"drinkThumb",children:[n.jsx(an,{type:"file",id:"drinkThumb",name:"drinkThumb",onChange:b,style:{display:"none"}}),n.jsxs(dn,{type:"button",children:[n.jsx(en,{style:pn}),n.jsx("span",{children:"Add image"})]}),d&&n.jsx(on,{src:d,alt:"Preview"}),n.jsx(I,{name:"drinkThumb",component:"div"})]}),n.jsxs(ln,{children:[n.jsxs(sn,{children:[n.jsx(W,{name:"drink",value:e.drink,onChange:y,placeholder:"Enter item drink"}),n.jsx(I,{name:"drink",component:"div"}),n.jsx(W,{name:"description",value:e.description,onChange:y,placeholder:"Enter about description"}),n.jsx(I,{name:"description",component:"div"}),n.jsxs(G,{htmlFor:"category",children:[n.jsx(U,{children:"Category"}),n.jsx(_,{name:"category",value:e.category,onChange:y,placeholder:"Category",children:({field:w,form:u})=>n.jsx(Y,{classNamePrefix:"Select",closeMenuOnSelect:!0,isClearable:!0,options:r.map(g=>({value:g,label:g})),name:w.name,id:"cocktail",...w,value:h?{value:h,label:h}:null,onChange:g=>{v(g?g.value:null),u.setFieldValue("category",g?g.value:null)},placeholder:"Cocktail"})})]}),n.jsxs(G,{htmlFor:"glass",children:[n.jsx(U,{children:"Glasses"}),n.jsx(_,{name:"glass",value:e.glass,onChange:y,placeholder:"Glasses",children:({field:w,form:u})=>n.jsx(Y,{classNamePrefix:"Select",closeMenuOnSelect:!0,components:xn,isClearable:!0,options:o.map(g=>({value:g,label:g})),name:w.name,id:"glasses",...w,value:m?{value:m,label:m}:"",onChange:g=>{g&&($(g.value),u.setFieldValue("glass",g.value))},placeholder:"Glasses"})})]})]}),n.jsxs(cn,{children:[n.jsxs(H,{children:[n.jsx(M,{type:"radio",name:"alcoholic",value:"Alcoholic",checked:e.alcoholic==="Alcoholic",onChange:()=>t({...e,alcoholic:"Alcoholic"})}),n.jsx(J,{children:"Alcoholic"})]}),n.jsxs(H,{children:[n.jsx(M,{type:"radio",name:"alcoholic",value:"Non alcoholic",checked:e.alcoholic==="Non alcoholic",onChange:()=>t({...e,alcoholic:"Non alcoholic"})}),n.jsx(J,{children:"Non-alcoholic"})]})]})]})]})})})},mn=l.div`
  position: relative;
  margin-bottom: 80px;
  width: 100%;
...
`,Q=[{value:"ml",label:"ml"},{value:"oz",label:"oz"},{value:"cl",label:"cl"},{value:"tsp",label:"tsp"},{value:"pinch",label:"pinch"},{value:"sprigs",label:"sprigs"},{value:"cup",label:"cup"},{value:"cups",label:"cups"},{value:"tblsp",label:"tblsp"}],En=({formData:e,setFormData:t,refId:i})=>{const{width:a}=ue(),r=a>=768?20:18,o=10,d=V(),c=T($=>$.filters.ingredients),[p,x]=s.useState(e.ingredients.length),h=($,b,y)=>{const w=[...e.ingredients];w[y][$]=b,t(u=>({...u,ingredients:w}))};s.useEffect(()=>{d(xe())},[d]);const v=()=>{p<o&&(t($=>({...$,ingredients:[...$.ingredients,{ingredient:"",measure:"",quantity:""}]})),x(p+1))},m=$=>{if(p>1){const b=[...e.ingredients];b.splice($,1),t(y=>({...y,ingredients:b})),x(p-1)}};return n.jsxs(mn,{children:[n.jsx(gn,{children:"Ingredients"}),n.jsx(R,{initialValues:e,innerRef:i,children:n.jsx(fn,{children:n.jsx(he,{name:"ingredients",render:()=>n.jsxs(n.Fragment,{children:[n.jsxs(wn,{children:[n.jsx(X,{type:"button",onClick:()=>m(),children:n.jsx(me,{size:16})}),n.jsx(vn,{children:p}),n.jsx(X,{type:"button",onClick:v,children:n.jsx(ge,{size:16})})]}),c&&n.jsx($n,{children:e.ingredients.map(($,b)=>{const y=Q.find(u=>u.value===$.measure),w=c.find(u=>u.title===$.ingredient);return n.jsxs(yn,{children:[n.jsxs(Sn,{children:[n.jsx(bn,{htmlFor:`ingredients[${b}]`,children:n.jsx(Cn,{className:"basic-single",classNamePrefix:"Select",closeMenuOnSelect:!0,isMulti:!1,isClearable:!0,options:c.map(({_id:u,title:g})=>({value:u,label:g})),name:`ingredients[${b}]`,id:`ingredient${b}`,value:w,onChange:({value:u})=>h("ingredientId",u,b),placeholder:"Ingredient",blurInputOnSelect:!0})}),n.jsxs(kn,{children:[n.jsx(jn,{name:`ingredients[${b}].quantity`,value:$.quantity||"",onChange:u=>h("quantity",parseInt(u.target.value,10),b)}),n.jsx("label",{htmlFor:`ingredients[${b}].measure`,children:n.jsx(_n,{className:"basic-single",classNamePrefix:"Select",options:Q,name:`ingredients[${b}].measure`,value:y||"",onChange:({value:u})=>h("measure",u,b),placeholder:"cl",isSearchable:!1})})]})]}),n.jsx(Tn,{type:"button",onClick:m,children:n.jsx(fe,{size:r})})]},b)})})]})})})})]})},Fn=l.h2`
  margin-bottom: 40px;
...
`,In=K().shape({instructions:C().min(100,"You need to add a description of at least 100 symbols")}),Vn=({formData:e,refId:t})=>n.jsx(n.Fragment,{children:n.jsx(R,{initialValues:e,validationSchema:In,innerRef:t,children:n.jsxs(Dn,{children:[n.jsx(Fn,{htmlFor:"instructions",children:"Recipe Preparation"}),n.jsx(_,{name:"instructions",children:({field:i})=>n.jsx(Pn,{...i,id:"instructions",placeholder:"Enter the recipe"})}),n.jsx(I,{name:"textareaValue",component:"div"})]})})}),An=l.div`
  display: flex;
  flex-direction: column;
...
`,Mn=()=>{const e=V(),t=T(v=>v.auth.user.birthDate),i=s.useRef(),a=s.useRef(),r=s.useRef(),o=new Date,d=new Date(t),c=o.getFullYear()-d.getFullYear(),[p,x]=s.useState({drink:"",description:"",alcoholic:c>=18?"Alcoholic":"Non alcoholic",category:"",glass:"",instructions:"",drinkThumb:"",ingredients:[{ingredientId:"",measure:"",quantity:""},{ingredientId:"",measure:"",quantity:""},{ingredientId:"",measure:"",quantity:""}]}),h=()=>{if(i.current&&a.current&&r.current){i.current.handleSubmit(),a.current.handleSubmit(),r.current.handleSubmit();const{values:v}=i.current,{values:m}=a.current,{values:$}=r.current,b={...p,alcoholic:v.alcoholic,category:v.category,glass:v.glass,ingredients:JSON.stringify(m.ingredients.filter(y=>y.ingredientId)),instructions:$.instructions};e(we(b))}};return n.jsxs(An,{children:[n.jsx(hn,{formData:p,setFormData:x,refId:i}),n.jsx(En,{formData:p,setFormData:x,refId:a}),n.jsx(Vn,{formData:p,setFormData:x,refId:r}),n.jsx(be,{to:"/my",children:n.jsx(zn,{type:"submit",onClick:h,children:"Add"})})]})},Bn=Mn,Rn=l.h3`
  margin-bottom: 20px;
