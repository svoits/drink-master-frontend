...
`;d.span`
  ...
  //   // border-color: ${({theme:e})=>e.inputBorderFocus};
  // }
`;const ln={backgroundColor:"#F3F3F3",width:"50px",height:"50px",borderRadius:"6px",color:"#161F37"},dn=ee().shape({drinkThumb:C().required("Cocktail photo is a mandatory field").url(),drink:C().required("Cocktail title is a mandatory field").min(3,"Cocktail name must contain at least 3 symbols"),description:C().required("Description of the cocktail is a mandatory field").min(10,"The cocktail description must contain at least 10 symbols"),category:C().required("Cocktail category is a required field"),glass:C().required("Cocktail glass is a required field")}),sn=He(),cn=({formData:e,setFormData:t,refId:i})=>{const a=V(),o=T(u=>u.filters.categories),r=T(u=>u.filters.glasses),[l,c]=s.useState(null),[p,x]=s.useState(!1),[m,b]=s.useState(null),[g,v]=s.useState("");s.useEffect(()=>{a(se()),a(ce())},[a]);const f=u=>{const S=u.target.files[0];if(S){const h=URL.createObjectURL(S);t({...e,drinkThumb:S}),c(h),x(!0)}},y=()=>{t({...e,drinkThumb:""}),c(null),x(!1)},k=u=>{const{name:S,value:h}=u.target;t({...e,[S]:h})};return n.jsx(Xe,{children:n.jsx(O,{initialValues:e,validationSchema:dn,innerRef:i,children:n.jsxs(Ze,{children:[n.jsxs(Ke,{htmlFor:"drinkThumb",children:[n.jsx(nn,{type:"file",id:"drinkThumb",name:"drinkThumb",onChange:f,style:{display:"none"}}),p?n.jsxs("button",{type:"button",onClick:y,children:[n.jsx(pe,{}),"Change image"]}):n.jsxs(tn,{type:"button",children:[n.jsx(Qe,{style:ln}),n.jsx("span",{children:"Add image"})]}),l&&n.jsx(en,{src:l,alt:"Preview"}),n.jsx(A,{name:"drinkThumb",component:"div"})]}),n.jsxs(on,{children:[n.jsxs(rn,{children:[n.jsx(G,{name:"drink",value:e.drink,onChange:k,placeholder:"Enter item drink"}),n.jsx(A,{name:"drink",component:"div"}),n.jsx(G,{name:"description",value:e.description,onChange:k,placeholder:"Enter about description"}),n.jsx(A,{name:"description",component:"div"}),n.jsxs(U,{htmlFor:"category",children:[n.jsx("p",{children:"Category"}),n.jsx(W,{name:"category",value:e.category,onChange:k,placeholder:"Category",children:({field:u,form:S})=>n.jsx(Y,{classNamePrefix:"Select",closeMenuOnSelect:!0,isClearable:!0,classNames:{control:h=>h.isFocused?"border-orange-600":"border-grey-300"},options:o.map(h=>({value:h,label:h})),name:u.name,id:"category",...u,value:m?{value:m,label:m}:null,onChange:h=>{b(h?h.value:null),S.setFieldValue("category",h?h.value:null)},placeholder:"Cocktail"})})]}),n.jsxs(U,{htmlFor:"glass",children:[n.jsx("p",{children:"Glasses"}),n.jsx(W,{name:"glass",value:e.glass,onChange:k,placeholder:"Glasses",children:({field:u,form:S})=>n.jsx(Y,{classNamePrefix:"Select",closeMenuOnSelect:!0,components:sn,isClearable:!0,classNames:{control:h=>h.isFocused?"border-orange-600":"border-grey-300"},options:r.map(h=>({value:h,label:h})),name:u.name,id:"glass",...u,value:g?{value:g,label:g}:"",onChange:h=>{h&&(v(h.value),S.setFieldValue("glass",h.value))},placeholder:"Glasses"})})]})]}),n.jsxs(an,{children:[n.jsxs(J,{children:[n.jsx(H,{type:"radio",name:"alcoholic",value:"Alcoholic",checked:e.alcoholic==="Alcoholic",onChange:()=>t({...e,alcoholic:"Alcoholic"})}),n.jsx("span",{children:"Alcoholic"})]}),n.jsxs(J,{children:[n.jsx(H,{type:"radio",name:"alcoholic",value:"Non alcoholic",checked:e.alcoholic==="Non alcoholic",onChange:()=>t({...e,alcoholic:"Non alcoholic"})}),n.jsx("span",{children:"Non-alcoholic"})]})]})]})]})})})};function pn(e){return K({tag:"svg",attr:{viewBox:"0 0 512 512"},child:[{tag:"path",attr:{d:"M405 136.798L375.202 107 256 226.202 136.798 107 107 136.798 226.202 256 107 375.202 136.798 405 256 285.798 375.202 405 405 375.202 285.798 256z"}}]})(e)}const un=d.div`
  position: relative;
  margin-bottom: 80px;
`,xn=d.h2`
  margin-bottom: 40px;
...
`,Tn=ee().shape({instructions:C().min(100,"You need to add a description of at least 100 symbols")}),En=({formData:e,refId:t})=>n.jsx(n.Fragment,{children:n.jsx(O,{initialValues:e,validationSchema:Tn,innerRef:t,children:n.jsxs(B,{children:[n.jsx(_n,{htmlFor:"instructions",children:"Recipe Preparation"}),n.jsx(E,{name:"instructions",children:({field:i})=>n.jsx(Cn,{...i,id:"instructions",placeholder:"Enter the recipe"})}),n.jsx(A,{name:"textareaValue",component:"div"})]})})}),Dn=d.div`
  display: flex;
  flex-direction: column;
...
`,Mn=()=>n.jsxs(Vn,{children:[n.jsx(An,{children:"Follow Us"}),n.jsx(ge,{})]}),zn=Mn,Bn=d.h3`
  margin-bottom: 28px;
...
`,Wn=()=>{const e=V(),t=T(o=>o.drinks.popularDrinks),{isLoading:i,error:a}=T(fe);return s.useEffect(()=>{e(be())},[e]),n.jsxs("div",{children:[n.jsx(Bn,{children:"Popular drinks"}),i&&n.jsx(ve,{}),a&&n.jsx("p",{children:"Sorry. There are no images ... 😭"}),n.jsx(On,{children:t.map(({_id:o,drinkThumb:r,drink:l,shortDescription:c})=>n.jsx(Rn,{children:n.jsxs(Ln,{href:`/api/drinks/popular/${o}`,children:[n.jsx(qn,{src:r,alt:l,width:90,height:90}),n.jsxs(Nn,{children:[n.jsx(Gn,{children:l}),n.jsx(Un,{children:c})]})]})},o))})]})},Yn=Wn,Jn=d.section`
  width: 100%;
  margin: 0;
  padding-top: 80px;
  padding-bottom: 80px;
