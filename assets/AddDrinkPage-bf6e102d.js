...
`,Wn=()=>{const e=V(),t=T(o=>o.drinks.popularDrinks),{isLoading:i,error:a}=T(fe);return s.useEffect(()=>{e(ve())},[e]),n.jsxs("div",{children:[n.jsx(Bn,{children:"Popular drinks"}),i&&n.jsx(be,{}),a&&n.jsx("p",{children:"Sorry. There are no images ... 😭"}),n.jsx(Rn,{children:t.map(({_id:o,drinkThumb:r,drink:l,shortDescription:c})=>n.jsx(On,{children:n.jsxs(Ln,{href:`/api/drinks/popular/${o}`,children:[n.jsx(qn,{src:r,alt:l,width:90,height:90}),n.jsxs(Nn,{children:[n.jsx(Gn,{children:l}),n.jsx(Un,{children:c})]})]})},o))})]})},Yn=Wn,Jn=d.section`
  width: 100%;
  margin: 0;
  padding-top: 80px;
  padding-bottom: 80px;
