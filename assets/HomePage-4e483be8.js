import{b as t,j as e,u as o,m as c,o as l,p as g,t as a,h,C as m,a as f,r as u,q as b,L as w}from"./index-57b64c05.js";import{u as p}from"./useDrink-090bef59.js";import"./drinks-selectors-4d719f03.js";const j=t.ul`
  display: flex;
  flex-wrap: wrap;
...
`,C=t.div`
  ...
  background: rgba(64, 112, 205, 0.5);
  filter: blur(104.8543701171875px);
`,P="/drink-master-frontend/assets/hero-img-mobile-1x-e307f486.png",F="/drink-master-frontend/assets/hero-img-desc-1x-42dd7e18.png",x="/drink-master-frontend/assets/hero-img-desc-1x-42dd7e18.png",U="/drink-master-frontend/assets/hero-img-mobile-2x-f9eefe96.png",W="/drink-master-frontend/assets/hero-img-desc-2x-9ccd0b0a.png",G="/drink-master-frontend/assets/hero-img-desc-2x-9ccd0b0a.png";function O(){return e.jsx("section",{children:e.jsx(m,{children:e.jsxs(M,{children:[e.jsxs(S,{children:[e.jsx($,{children:"Craft Your Perfect Drink with Drink Master"}),e.jsx(C,{}),e.jsx(H,{children:"Unlock your inner mixologist with Drink Master, your one-stop destination for exploring, crafting, and mastering the world`s finest beverages."}),e.jsx(E,{to:"/add",children:"Add drink"})]}),e.jsxs(T,{children:[e.jsx(A,{}),e.jsxs("picture",{children:[e.jsx("source",{media:"(min-width:1200px)",srcSet:`${x} 1x, ${G} 2x`}),e.jsx("source",{media:"(min-width:768px)",srcSet:`${F} 1x, ${W} 2x`}),e.jsx("source",{media:"(max-width:767px)",srcSet:`${P} 1x, ${U} 2x`}),e.jsx("img",{src:x,alt:"main-coctail"})]}),e.jsx(B,{})]})]})})})}function R(){const i=f(),{isLoggedIn:n}=L(),{isLoading:s,error:r}=p();return u.useEffect(()=>{n&&i(b())},[i,n]),e.jsxs(e.Fragment,{children:[s&&e.jsx(w,{}),r&&e.jsx("p",{children:r}),e.jsx(O,{}),e.jsx(v,{})]})}export{R as default};
